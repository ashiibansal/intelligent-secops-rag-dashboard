...
main_tab1, main_tab2 = st.tabs(
    ["🤖 Incident Response System", "📊 Security Analytics Dashboard"]
)

# ============================================================
# INCIDENT RESPONSE SYSTEM (YOUR ORIGINAL APP)
# ============================================================

with main_tab1:

    # Keep your original internal tabs exactly as they were
...
# ============================================================
# SECURITY ANALYTICS DASHBOARD TAB
# ============================================================
